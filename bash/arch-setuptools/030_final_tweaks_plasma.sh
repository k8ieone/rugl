...
then
    ...
    sudo pacman -S plasma-meta ark p7zip unrar unarchiver lzop lrzip dolphin gwenview spectacle konsole code kdenlive firefox ffmpegthumbs kdegraphics-thumbnailers vlc mpv
fi
